    ...
    <div className="min-h-screen bg-[#fafaf9]">
      <div className="border-b border-slate-200 bg-white">
        <div className="container mx-auto px-4 py-10 sm:px-6 md:py-14 lg:px-8">
          <div className="h-10 max-w-xl animate-pulse rounded-lg bg-slate-200 motion-reduce:animate-none sm:h-11 md:h-12" />
      ...
      <div className="sticky top-20 z-40 border-b border-slate-200 bg-slate-50">
        <div className="container mx-auto px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-4 md:flex-row md:items-center">
            <div className="h-11 flex-1 animate-pulse rounded-lg bg-slate-200 motion-reduce:animate-none" />
            <div className="h-11 w-full shrink-0 animate-pulse rounded-lg border border-slate-200 bg-white md:w-52 motion-reduce:animate-none" />
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
            ...
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="py-6 animate-pulse motion-reduce:animate-none">
                <div className="flex gap-6">
                  <div className="hidden h-32 w-48 shrink-0 rounded-lg bg-slate-200 sm:block" />
          ...
          <aside className="lg:col-span-4">
            <div className="sticky top-24 space-y-6">
              <div className="animate-pulse rounded-xl border border-slate-200 bg-white p-6 shadow-sm motion-reduce:animate-none">
...
export function ReportsHubSkeleton() {
  return (
    <div className="min-h-screen bg-[#fafaf9]">
      <div className="border-b border-slate-200 bg-white">
        <div className="container mx-auto px-4 py-10 sm:px-6 md:py-14 lg:px-8">
          <div className="h-10 max-w-lg animate-pulse rounded-lg bg-slate-200 motion-reduce:animate-none md:h-12" />
          <div className="mt-4 h-4 max-w-2xl animate-pulse rounded bg-slate-200 motion-reduce:animate-none" />
        </div>
      </div>
      <div className="sticky top-20 z-40 border-b border-slate-200 bg-slate-50">
        <div className="container mx-auto px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-4 md:flex-row md:flex-wrap md:items-center">
            <div className="h-11 min-w-[200px] flex-1 animate-pulse rounded-lg bg-slate-200 motion-reduce:animate-none" />
            <div className="h-11 w-44 animate-pulse rounded-lg border border-slate-200 bg-white motion-reduce:animate-none" />
            <div className="h-11 w-40 animate-pulse rounded-lg border border-slate-200 bg-white motion-reduce:animate-none" />
          </div>
        </div>
      </div>
      <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
                ...
                <div key={y}>
                  ...
                  <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                    {Array.from({ length: 3 }).map((_, i) => (
                      <div
                        key={i}
                        className="h-80 animate-pulse rounded-xl border border-slate-200 bg-white motion-reduce:animate-none"
                      />
                    ))}
                  </div>
                </div>
      ...
      <div className="container mx-auto px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {Array.from({ length: 7 }).map((_, i) => (
            <div
              key={i}
              className="h-28 animate-pulse rounded-xl border border-slate-200 motion-reduce:animate-none"
            />
          ))}
        </div>
        <div className="mt-12 grid grid-cols-1 gap-8 lg:grid-cols-2">
          {Array.from({ length: 2 }).map((_, i) => (
            <div
              key={i}
              className="h-64 animate-pulse rounded-xl border border-slate-200 p-6 motion-reduce:animate-none"
            >
