    ...
    <div className="min-h-screen bg-[#fafaf9]">
      <div className="border-b border-slate-200 bg-white">
        <div className="container mx-auto px-4 py-10 sm:px-6 md:py-14 lg:px-8">
          ...
          <div className="mb-4 h-7 w-24 animate-pulse rounded-acepBtn bg-slate-200 motion-reduce:animate-none" />
          <div className="h-9 max-w-3xl animate-pulse rounded-acepBtn bg-slate-200 motion-reduce:animate-none sm:h-10 md:h-11" />
          ...
          <div className="space-y-6 lg:col-span-8">
            <div className="animate-pulse rounded-acepCard border border-slate-200 bg-white p-6 md:p-8 motion-reduce:animate-none">
              ...
              <div className="flex flex-wrap gap-3">
                <div className="h-11 w-44 rounded-acepBtn bg-acep-primary/30" />
                <div className="h-11 w-32 rounded-acepBtn border border-slate-200 bg-slate-50" />
              </div>
            </div>
            <div className="animate-pulse rounded-acepCard border border-slate-200 bg-white p-6 motion-reduce:animate-none">
              ...
              <div className="space-y-3">
                <div className="h-14 w-full rounded-acepBtn border border-slate-100 bg-slate-50" />
                <div className="h-14 w-full rounded-acepBtn border border-slate-100 bg-slate-50" />
              </div>
            </div>
          </div>
