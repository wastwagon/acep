...
export default async function TeamPage() {
  const entry = await getAcepSnapshotByUrl("https://acep.africa/team/");
    ...
    <div className="bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="max-w-3xl">
          <h1 className="font-display text-3xl sm:text-4xl font-semibold tracking-tight text-slate-900">{title || "Our Team"}</h1>
