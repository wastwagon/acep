...
const URL = "https://acep.africa/future-of-energy-conference/";
...
export default async function FutureOfEnergyConferencePage() {
  const r = await resolveProsePage(URL);
  if (!r) notFound();
  return <MarketingProsePage {...r} aside="fec" />;
}
